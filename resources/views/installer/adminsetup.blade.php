...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid stepper stepper-pills stepper-column" id="kt_create_account_stepper">
        ...
        <div class="alert alert-success shadow-lg" style="height: 53px; background: #42ad42;" id="success-alert">
            <h1 style="color: white; font-size:15px; text-align:center">{{ session()->get('success') }}</h1>
        </div>
        @endif
        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-700px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="my-auto pb-5" action="{{ route('admin_setup')}}" method="POST">
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-10 pb-lg-15">
                                    <!--begin::Title-->
                                    <h2 class="fw-bolder text-dark">Admin setup</h2>
                                    <!--end::Title-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" class="form-control form-control-lg" name="admin_email" placeholder="" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="password" class="form-control form-control-lg" name="admin_password" placeholder="" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="password" class="form-control form-control-lg" name="confirmpassword" placeholder="" value="" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                        ...
                        <div class="d-flex flex-stack pt-15">
                            <div class="mr-2">
                                <a type="button" class="btn btn-lg btn-light-primary me-3" href="{{ route('Databasesetup')}}">
                            ...
                            <div>
                                <a type="button" class="btn btn-lg btn-light-primary me-3" href="{{ route('done')}}">

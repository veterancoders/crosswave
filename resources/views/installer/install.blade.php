        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-700px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="my-auto pb-5" action="{{ route('process_db')}}" method="POST">

                        @csrf
                        <div class="current" data-kt-stepper-element="content">
                            <!--begin::Wrapper-->
                            <div class="w-100">
                                <div id="myDIV" style="display: none;padding-bottom:40px;">
                                    <img src="{{asset('images/loader/spin.gif') }}" width="60px"><span style="font-size: 25px;font-weight:bold;font-family:cursive;padding-left:5px;color:#705244;"> Please wait. Do not refresh your browser!</span>
                                </div>
                                <!--begin::Heading-->
                                <div class="pb-10 pb-lg-15">
                                    <!--begin::Title-->
                                    <h2 class="fw-bolder text-dark">Install your Application (click on install)</h2>
                                    <!--end::Title-->
                                </div>
                        ...
                        <div class="d-flex flex-stack pt-15">
                            ...
                            <div>
                                <button onclick="myFunction()" type="submit" class="btn btn-lg btn-primary">Install

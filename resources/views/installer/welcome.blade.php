                    ...
                    <form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form">
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-10 pb-lg-15">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Notice-->
                                    <div class="text-muted fw-bold fs-6 pt-3">Thank you for choosing Investpro. Please follow the steps
                                        to complete Investpro Installation.
                        ...
                        <div class="d-flex flex-stack pt-15">
                            ...
                            <div>
                                ...
                                <a type="button" href="{{route('Checkrequirement')}}" class="btn btn-lg btn-primary">Continue
